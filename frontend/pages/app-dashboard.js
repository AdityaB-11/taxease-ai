  ...
  const upload = async (e) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, {
        role:'assistant', 
        text: `📊 **Upload Summary** ✅\n\n💰 Total Income: ₹${data.total_income.toLocaleString('en-IN')}\n💸 Total Expenses: ₹${data.total_expenses.toLocaleString('en-IN')}\n🎯 Potential Deductions: ₹${data.potential_deductions.toLocaleString('en-IN')}\n\n${data.transactions.length} transactions analyzed successfully!\n\n💡 I can help you with Indian tax deductions under Section 80C, 80D, and more!`
      }])
    } catch(e) {
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center gap-3 mb-4">
            <Link href="/landing" className="flex items-center gap-3 hover:opacity-80 transition">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">TaxEase AI</h1>
                <p className="text-xs text-gray-500">Tax Assistant</p>
              </div>
            </Link>
          </div>
        </div>
          ...
          {summary && (
            <div className="mb-6 space-y-2 animate-fade-in">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                ...
                <div className="text-lg font-semibold text-green-900">₹{summary.total_income.toLocaleString('en-IN')}</div>
              </div>
              <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                <div className="text-xs text-red-700 font-medium">Total Expenses</div>
                <div className="text-lg font-semibold text-red-900">₹{summary.total_expenses.toLocaleString('en-IN')}</div>
              </div>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <div className="text-xs text-blue-700 font-medium">Tax Deductions</div>
                <div className="text-lg font-semibold text-blue-900">₹{summary.potential_deductions.toLocaleString('en-IN')}</div>
                <div className="text-xs text-blue-600 mt-1">80C, 80D eligible</div>
              </div>
            </div>
          )}
          ...
          {messages.length === 0 ? (
            <div className="h-full flex items-center justify-center">
              <div className="text-center max-w-2xl">
                <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-orange-100 to-green-100 rounded-2xl flex items-center justify-center">
                ...
                <p className="text-gray-600 mb-2">Your AI-powered Indian tax filing assistant</p>
                <p className="text-sm text-gray-500 mb-8">Upload your bank statement CSV and get personalized advice on Income Tax, GST, and deductions (80C, 80D, etc.)</p>
